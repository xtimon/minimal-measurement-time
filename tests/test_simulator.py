...
class TestGPUInformationMeasurementSimulator:
    ...
    def test_temperature_dependence(self):
        ...
        # Lower temperature
        sim_low = GPUInformationMeasurementSimulator(temperature=100.0, use_gpu=False, suppress_logging=True)
        ...
        # Lower temperature should give longer measurement time
