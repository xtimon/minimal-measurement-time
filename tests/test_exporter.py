...
class TestResultExporter:
    ...
    def test_export_to_text_detailed(self):
        ...
        results = {
            ...
            "gamma_factors": {"total": 5.5, "base": 2.0, "statistics": 1.5, "correlations": 1.0, "quasiparticles": 1.0},
            "decoherence": {"T1": 1e-3, "T2": 1e-4, "factor": 1.5, "enabled": True},
            "noise": {
                "temperature": 1.0,
            ...
            "limits": {"fundamental": 2.5e-12, "technical": 1e-9, "landauer": 1.3e-14, "quantum": 1e-14},
        }
    ...
    def test_export_to_text_summary(self):
        ...
        results = {
            "min_measurement_time": 1.23e-9,
            "parameters": {"temperature": 300.0, "stats_type": 0, "N": 1000},
            "gamma_factors": {"total": 5.5},
        }
    ...
    def test_export_comparison(self):
        ...
        systems_data = [
            {"name": "System 1", "measurement_time": 1e-9, "complexity": 5.0, "type": "Fermion"},
            {"name": "System 2", "measurement_time": 2e-9, "complexity": 6.0, "type": "Boson"},
        ]
