...
class ResultExporter:
    ...
    @staticmethod
    def export_to_text(results: Dict[str, Any], filename: Optional[str] = None, format_type: str = "detailed") -> str:
        """
    ...
    def _generate_detailed_report(results: Dict[str, Any]) -> List[str]:
        ...
        if "parameters" in results:
            ...
            # Параметры шума
            if (
                params.get("noise_temperature") is not None
                or params.get("shot_noise_factor") is not None
                or params.get("technical_noise") is not None
            ):
                report.append("")
    ...
    @staticmethod
    def export_comparison(systems_data: List[Dict[str, Any]], filename: Optional[str] = None) -> str:
        """
